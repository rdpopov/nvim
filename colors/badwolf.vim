...
call s:HL('NormalNC', 'plain', 'darkgravel')
...
" Spelling {{{
  ...
  call s:HL('SpellCap', 'tardis', 'bg', 'bold', 'tardis')
  call s:HL('SpellBad', 'saltwatertaffy', 'bg', 'bold', 'saltwatertaffy')
  call s:HL('SpellLocal', '', '', '', 'dalespale')
  call s:HL('SpellRare', '', '', '', 'dalespale')
