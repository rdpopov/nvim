...
-- NOTE: is there a more automated way to extract the colors from a colorscheme?
ColorPalette = {
    ['ayu'] = setmetatable({
        ['Blue']  = '#39BAE6',
        ['Red']  = '#FF3333',
...
-- NOTE: make this into an external file
...
-- NOTE: make this into an external file
-- TODO: make a way for this to be generated by a function and not hardcoded
...
M.get_lang_git_name = function(self)
  ...
  if clean_status then 
	...
	-- Scope
	local Scope = ""
	-- TODO: make a function that dos a query based on the language and as a fallback get something from the lsp?
	-- NOTE: do this for: c/cpp, rust, nim, lua, python.
